...
from service.common.status import (HTTP_400_BAD_REQUEST, HTTP_404_NOT_FOUND,
...
class TestErrorHandlers(TestCase):
    ...
    def test_bad_request_handler(self):
        with self.app.test_request_context():
            response = self.app.handle_user_exception(
    ...
    def test_not_found_handler(self):
        ...
        response = self.client.get(
            "/nonexistent", environ_overrides={"wsgi.url_scheme": "https"}
        )
